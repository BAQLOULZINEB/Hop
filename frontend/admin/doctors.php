...
if(!empty($search)) {
    $search = "%" . $search . "%";
    $where_clause = "WHERE u.nom LIKE ? OR u.email LIKE ? OR m.specialite LIKE ?";
}

// Fetch doctors
$sql = "SELECT m.*, u.nom, u.email, u.role 
        FROM medecin m 
...
<head>
    ...
    <title>Gestion des Médecins - Système de Gestion Hospitalière</title>
    ...
    <div class="page">
        <div class="dashboard">
            ...
            <ul class="links">
                ...
                <li class="num num1">
                    <a class="listted" href="doctors.php" class="active">
            ...
            <div class="header pro-header">
                ...
                <div class="header-center">
                    <form action="" method="get" class="search-bar">
                        <input type="search" name="search" placeholder="Rechercher un médecin..." value="<?php echo htmlspecialchars($search); ?>">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="status <?php echo $row['disponibilite'] ? 'active' : 'inactive'; ?>">
                                        <?php echo $row['disponibilite'] ? 'Disponible' : 'Indisponible'; ?>
                                    </span>
                                </td>
                                <td>
                                    <a href="edit_doctor.php?id=<?php echo $row['id']; ?>" class="btn-edit">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </a>
                                    <a href="doctors.php?delete=<?php echo $row['id']; ?>" class="btn-delete" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce médecin ?');">
